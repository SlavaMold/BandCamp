	...
	public class MemberRepository : IMemberRepository
	{
		...
		public void Add(Member member)
		{
			string sql = @"INSERT INTO Members 
                (FirstName, LastName, Role, ExperienceYears, JoinDate, PhotoPath, IsActive)
                VALUES 
                (@FirstName, @LastName, @Role, @ExperienceYears, @JoinDate, @PhotoPath, @IsActive)";
			using (var cmd = new SQLiteCommand(sql, _conn))
			{
				...
				cmd.Parameters.AddWithValue("@ExperienceYears", member.ExperienceYears);
				...
				cmd.ExecuteNonQuery();
				member.Id = (int)(long)new SQLiteCommand(
		...
		public void Update(Member member)
		{
			string sql = @"UPDATE Members SET 
                ...
                ExperienceYears=@ExperienceYears, JoinDate=@JoinDate,
